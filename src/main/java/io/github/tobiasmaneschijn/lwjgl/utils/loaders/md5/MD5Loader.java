package io.github.tobiasmaneschijn.lwjgl.utils.loaders.md5;
...
public class MD5Loader {
    ...
    public static GameObject process(MD5Model md5Model, Vector4f defaultColour) throws Exception {
        ...
        GameObject gameItem = new GameObject(meshes);
