...
public class Hud {
    ...
    public void render(Window window) {
        ...
        // Circle
        nvgBeginPath(vg);
        nvgCircle(vg, (float )posx.get(0), (float )posy.get(0) + 75, 10);
        nvgFillColor(vg, rgba(0xc1, 0xe3, 0xf9, 200, colour));
        nvgFill(vg);
        ...
        nvgText(vg, window.getWidth() / 2 - 150, window.getHeight() - 95,"LUCID CHESS");
        ...
        nvgTextAlign(vg, NVG_ALIGN_LEFT | NVG_ALIGN_TOP);
        nvgFillColor(vg, rgba(0xe6, 0xea, 0xed, 255, colour));
        nvgText(vg, window.getWidth() - 300, window.getHeight() - 95, dateFormat.format(new Date()));
